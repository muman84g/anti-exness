...
#define BRIDGE_NAME "BotBridge_s22"
#define BRIDGE_VERSION "2026-07-26-s22-squeeze-pullback-v2-retcode-tz-account"
#define BRIDGE_COMMANDS "ECHO,CAPS,ACCOUNT,INFO,HIST,OPEN,PENDING,POSITIONS,POSITION,ORDERS,MODIFY,CANCEL,CLOSE"

input string InpCommandFile = "cmd_s22.txt";
input string InpResponseFile = "res_s22.txt";
