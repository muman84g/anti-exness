...
#define BRIDGE_NAME "BotBridge_sNN"
#define BRIDGE_VERSION "template-shared-account-close-deal-v1"
#define BRIDGE_COMMANDS "ECHO,CAPS,ACCOUNT,INFO,HIST,OPEN,PENDING,POSITIONS,POSITION,ORDERS,CLOSEDEAL,MODIFY,CANCEL,CLOSE"

input string InpCommandFile = "cmd_sNN.txt";
input string InpResponseFile = "res_sNN.txt";
