...
#define BRIDGE_NAME "BotBridge_s20"
#define BRIDGE_VERSION "2026-07-07-xau-large-candle-short-v1-dedicated-ipc"
#define BRIDGE_COMMANDS "ECHO,INFO,HIST,OPEN,PENDING,POSITIONS,POSITION,ORDERS,MODIFY,CANCEL,CLOSE"

input string InpCommandFile = "cmd_s20.txt";
input string InpResponseFile = "res_s20.txt";
