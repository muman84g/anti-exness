...
# 縲先姶逡･s14繧ｳ繝ｳ繧ｻ繝励ヨ: GBPUSDm 騾・ｼｵ繧翫げ繝ｪ繝・ラ・倶ｺ梧焚蛻怜・隗｣邂｡逅・Δ繝ｳ繝・き繝ｫ繝ｭ豕募ｮ滄°逕ｨ繝懊ャ繝医・# ------------------------------------------------------------------------------
# - Instrument: GBPUSDm (GBP/USD Pro Account)
# - Logic: Bot A (Always in market, reverses on TP, continues on SL)
#          Bot B (Grid hedging bot, triggers at S ﾂｱ W/2 with counter-trend entry)
# - Weekend Close: JST Friday 20:00 JST to Monday 07:00 JST (Suspends, closes all positions)
# - News Filter: Avoids major high-impact news window (e.g., ﾂｱ2 hours)
