...
| bot26 / S26 | `exness-bot-26` | `bot26` | `検討中/chatgpt案/0_bot26実装PV2C520_OOS_001` | `SOURCE_BACKTEST.md`: USTEC/USOIL `PV2C520_DEVQ80_H75_FORWARD_R1`、stale >120秒 fail closed、decision基準壁時計75分hold。旧60本bar-clock ledgerとlive整合runnerを分離済み。 | User-authorized live (`live=true`, `shadow=false`)。DEV固定選択、既観測診断は昇格根拠外。Deploy/restart/real order未検証。 |
| bot27 / S27 | `exness-bot-27` | `bot27` | `検討中/chatgpt案/0_bot27実装PV2C859_OOS_001` | `SOURCE_BACKTEST.md`: USTEC `PV2C859_DEVQ825_H90_FORWARD_R1`、threshold `0.6693523825105777`、actual-entry基準90分hold。 | User-authorized live (`live=true`, `shadow=false`)。DEV固定選択、既観測診断は昇格根拠外。Deploy/restart/real order未検証。 |
