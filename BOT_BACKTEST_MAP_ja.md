...
| bot19 / S19 | `exness-bot-19` | `bot19` | `backtest34` | `SOURCE_BACKTEST.md`: `backtest34_bot18_small_range_filter`, run `20260705_2200_pilot_dev_tick_d10_e75_fs_m80_b2k`, candidate `baseline_recovery_loweff_cap10_short_deep8_extreme6_e75_fs_m80_b2k`, variant `value_d10_tp1`. | Historical 2026-07-08 note said running. Uses server-side pending stop. |
