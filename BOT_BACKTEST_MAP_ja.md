...
| bot21 / S21 | `exness-bot-21` | `bot21` | `backtest67_1_bot21` | `SOURCE_BACKTEST.md`: Ehlers top3 current implementation for `US500_137_1h`, `AUDUSD_021_1h`, `USDJPY_035_1h`. | Live-order params enabled by explicit user instruction. Current runner requires the updated `CLOSEDEAL` bridge; deployment, bridge compilation/attachment, service recreation, and noVNC account state remain separate runtime actions. |
