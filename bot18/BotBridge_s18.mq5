...
#define BRIDGE_NAME "BotBridge_s18"
#define BRIDGE_VERSION "2026-07-13-s18-v2-dedicated-ipc"
#define BRIDGE_COMMANDS "ECHO,INFO,HIST,OPEN,PENDING,POSITIONS,POSITION,ORDERS,MODIFY,CANCEL,CLOSE"

input string InpCommandFile = "cmd_s18.txt";
input string InpResponseFile = "res_s18.txt";
