...
class EABridgeServer:
    ...
    def _acquire_ipc_lock(self, timeout):
        """Serialize command/response access across separate bot processes."""
    ...
    def _send_command_once(self, cmd_str, timeout):
        # The configured command/response files are one IPC lane for this bot.
        # Keep calls strictly serialized across threads and processes, and
        # ignore response files that pre-date this command.
