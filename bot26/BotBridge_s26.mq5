...
#define BRIDGE_NAME "BotBridge_s26"
#define BRIDGE_VERSION "2026-08-21-s26-midclose-v1"
#define BRIDGE_COMMANDS "ECHO,CAPS,ACCOUNT,INFO,HIST,OPEN,PENDING,POSITIONS,POSITION,ORDERS,CLOSEDEAL,MODIFY,CANCEL,CLOSE"

input string InpCommandFile = "cmd_s26.txt";
input string InpResponseFile = "res_s26.txt";
